...
namespace RemoteTech.SimpleTypes
{
    ...
    public class ComputerModeMapper
    {
        ...
        public void mapFlightMode(
            FlightMode flightMode,
            FlightAttitude flightAttitude,
        ...
        )
        {
            ...
            switch (flightMode)
            {
                ...
                {
                    computerMode = ComputerMode.Kill;
                    break;
                }
                case FlightMode.AttitudeHold:
                {
                    ...
                    switch (frame)
                    {
                        ...
                        {
                            computerMode = ComputerMode.Node;
                            break;
                        }
                        case ReferenceFrame.Orbit:
                        {
                            computerMode = ComputerMode.Orbital;
                            break;
                        }
                        case ReferenceFrame.Surface:
                        {
                            computerMode = ComputerMode.Surface;
                            break;
                        }
                        case ReferenceFrame.TargetParallel:
                        {
                            computerMode = ComputerMode.TargetPos;
                            break;
                        }
                        case ReferenceFrame.TargetVelocity:
                        {
                            computerMode = ComputerMode.TargetVel;
                            break;
                        }
                    }
                    break;
